...
const { verificaToken, verificaAdmin } = require('../middelwares/authentication');
...
app.put('/usuario/:id', [verificaToken, verificaToken], function(req, res) {
...
app.delete('/usuario/:id', [verificaToken, verificaToken], function(req, res) {
